...
const LoginPage = () => {
  return (
    <div className="min-h-screen bg-black flex flex-col w-full items-center justify-center p-4">
      <NavBar />
      ...
      <footer className=" border-t border-gray-800 text-white py-28  px-16 mt-8 w-full ">
